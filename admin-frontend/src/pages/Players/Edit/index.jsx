...
const Edit = () => {
	...
	useEffect(() => {
		...
		/*let playerData = {
			...
			history: [
				{id: "dshh47dshh48sd", type: "Пополнение", date: "12.02.2020", status: "Выполнено", paymentMethod: "PayKassaPro", currency: "BTC", amount: "0.23232"}
			],
			totalDeposits: "33232 РУБ",
			totalWithdraws: "3232 РУБ",
			profit: "+3839 %",
			passport: {
				name: "Игорь",
			},
			accountStatus: "noblocked",
		};
