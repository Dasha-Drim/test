...
// components
import Bingo37 from "../../games/bingo37/Bingo37";
...
const BingoPage = (props) => {
	...
	useEffect(() => {
		document.querySelector("html").classList.add("bingo37");
		return () => document.querySelector("html").classList.remove("bingo37");
	}, [])
	...
	function updateSize() {
		try {
			if(window.screen.width > 992) {
				...
				if (document.querySelector(".Bingo37__Table")) document.querySelector(".Bingo37__Table").style.height = "auto";
				return false;
			}

			let bodyHeight = document.body.clientHeight;
			let roundInfoMobileHeight = document.querySelector(".Bingo37__RoundInfo_Mobile").clientHeight;
			let controlsHeight =  document.querySelector(".Bingo37__Controls").clientHeight;
			...
			document.querySelector(".Bingo37__Table").style.height = document.querySelector(".Table-inner").clientHeight*compressionRatio + "px";
		} catch(e) {
	...
	return (
		<div className="BingoPage" >
			...
			]} sound={{drawing: drawing, win: win, chip: chip}} 
			icons={{back: back, arrow: arrow, trash: trash, repeat: repeat, cross: cross, x2: x2, crossBtn: crossBtn, fullscreen: fullscreen}} 
			img={{machine: machine}} 
