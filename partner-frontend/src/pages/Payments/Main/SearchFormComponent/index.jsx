...
const SearchFormComponent = (props) => {
	...
	*/
	...
	let validationSchema = Yup.object({
		...
		dateFrom: Yup.date().min(new Date(), "Слишком рано"),
		dateTo: Yup.date(),
	})
	...
	const transactionStatusOptions = [
		{ value: '', label: 'Можно выбрать' },
		{ value: 'pending_deposit', label: 'Ожидание пополнения' },
		{ value: 'pending_withdraw', label: 'Ожидание списания' },
